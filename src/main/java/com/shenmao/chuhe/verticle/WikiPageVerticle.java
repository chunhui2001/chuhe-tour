...
public class WikiPageVerticle extends AbstractVerticle {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(WikiPageVerticle.class);
  ...
  public void start(Future<Void> startFuture) throws Exception {
    ...
    dbClient = JDBCClient.createShared(vertx, new JsonObject()
      .put("url", config().getString(CONFIG_WIKIDB_JDBC_URL, "jdbc:hsqldb:file:db_wiki/wiki_database"))
